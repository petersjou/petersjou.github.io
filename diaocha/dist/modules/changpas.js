...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/ae1b7cddb03245a42c9e3ee27757a6dd', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/ae1b7cddb03245a42c9e3ee27757a6dd',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		methods: {
			...
			tocahngepas: function tocahngepas() {
				var self = this;
				var oldpas = self.$el('uput').attr.value;
				var password = self.$el('pput').attr.value;
				var password2 = self.$el('pput2').attr.value;
				if (oldpas == '' || password == '' || password2 == '') {
					self.baocuo = '密码不能为空';
					return;
					...
					getitem(function () {
						self.getStarCount('user/modifyPasswd.json?token=' + self.token + '&userId=' + self.userid + '&oldPasswd=' + oldpas + '&newPasswd=' + password, function (res) {
							var data = res.data;
							if (data.status == 1) {
